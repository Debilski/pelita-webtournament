...
import { animate, createScope, createTimeline, FunctionValue, Scope, svg, Timeline } from 'animejs';
      ...
      tl.label('draw')
        ...
        .sync(
          animate(wallPathDrawable, {
            ...
            strokeWidth: [2, 2],
            delay: ((_target, index: number) => index * 25) as FunctionValue, // need to help the compiler
